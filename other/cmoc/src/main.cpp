/*  $Id: main.cpp,v 1.140 2021/11/20 04:32:17 sarrazip Exp $
...
"\n";
    ...
    cout <<
        ...
        "--deps[=F]           Create a .d file containing a makefile rule giving the\n"
        "                     dependencies of the compiled file.\n"
        "                     If a filename (F) is given, it is used instead of forming the\n"
        "                     dependency filename from the code output filename.\b"
        ...
        "--thommo             Compile a Thomson MO .bin file.\n"
        "--thomto             Compile a Thomson TO .bin file.\n"
        ...
        "--void-target        Compile for a target that has no I/O system known to CMOC. Implies --srec.\n"
