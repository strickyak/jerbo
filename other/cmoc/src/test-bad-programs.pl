...
program => q!
    ...
    !,
expected => [
    qq!,check-prog.c:4: __error__: floating-point arithmetic is not supported on this platform!,
...
expected => [
    ...
    qq!,check-prog.c:11: __error__: floating-point arithmetic is not supported on this platform!,
...
expected => [
    ...
    qq!,check-prog.c:6: __warning__: argument 2 of printf() is of type `float' but the placeholder is not %f!,
