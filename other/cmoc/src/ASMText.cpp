/*  $Id: ASMText.cpp,v 1.135 2021/08/16 16:45:53 sarrazip Exp $
    ...
    for (;;)
    {
        ...
        for (size_t i = 0; i < elements.size(); ++i)
        {
            ...
            else if (pushDLoadXLoadD(i))
            {
                ...
                modified = true;
            else if (stripUselessBitwiseOp(i))
                modified = true;
            else if (useStage2Optims)
            {
                ...
                else if (transformPshsXPshsX(i))
                {
                    ...
                    modified = true;
                else if (removePCRIfRelocatabilityNotSupported(i))
                    modified = true;
            }
        }
...
ASMText::removePCRIfRelocatabilityNotSupported(size_t index)
{
    ...
    index = findNextInstrBeforeLabel(index);
    if (index == size_t(-1))
        return false;
