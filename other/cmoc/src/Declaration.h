/*  $Id: Declaration.h,v 1.33 2021/11/13 20:20:45 sarrazip Exp $
...
public:
    ...
    //
    CodeStatus emitStaticArrayOfFixedSizeStringLiterals(ASMText &out);
    ...
    CodeStatus emitStaticValues(ASMText &out, const Tree *arrayElementInitializer, const TypeDesc *requiredTypeDesc);
