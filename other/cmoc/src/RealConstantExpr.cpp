/*  $Id: RealConstantExpr.cpp,v 1.15 2020/08/05 00:18:40 sarrazip Exp $
...
RealConstantExpr::getRepresentation() const
{
    ...
    else
    {
        ...
        bool is40BitFormat = (targetPlatform == COCO_BASIC || targetPlatform == USIM);  // if false, then OS-9 C format
        if (is40BitFormat)
