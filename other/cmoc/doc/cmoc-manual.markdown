...
Date of this manual: 2021-11-09
...
Version of CMOC covered by this manual: **0.1.72**
...
[Dragon](https://en.wikipedia.org/wiki/Dragon_32/64) computer,
...
- The `static` and `extern` keywords. However, an extern declaration must be
  at the global level, not inside a function.
...
The argument to --prefix is often something like /usr/local.
...
`--coco`, `--dragon`, `--os9`, `--vectrex`, `--thommo`, `--thomto`).
...
Note that CMOC always generates position independent code by default. This rule
